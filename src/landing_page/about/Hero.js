...
function Hero() {
    return (
        <div className="container p-5  text-dark-emphasis">
            <div className="row p-5  text-center">
                <h1 className="fs-2 fw-medium">
                    We pioneered the discount broking model in India. <br />
                    Now, we are breaking ground with our technology.
                </h1>
            </div>
            <div
                className="row border-top pt-5 px-5 mx-5"
            ...
            >
                ...
                <div className="col p-5">
                    ...
                    <p>
                        <a
                            href="/about"
                            className="text-decoration-none   opacity-80"
                        >
                            Rainmatter
                        </a>
                    ...
                    <p>
                        ...
                        <a href="/about" className="text-decoration-none  opacity-80">
                            saying about us.
                        </a>
                    </p>
                </div>
